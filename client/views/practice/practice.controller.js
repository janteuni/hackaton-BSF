...
angular.module('bsf')
  ...
  .controller('PracticeCtrl', function ($scope, $route, Game, $location) {
    ...
    vm.strHelp = {p:"\Le texte entre la balise ouvrante \<p> et la balise fermante </p> est un paragraphe.",
      ...
      weight:"Permet de contrôler l'épaisseur du texte (ex : Font-weight : bold; Met le texte de la balise indiquée en gras)",
      ...
      margin:"Marge extérieure. Les 4 arguments sont les tailles des marges en pixel (haute, droite, basse, gauche).",
      padding:"Marge intérieure dont les arguments sont décrits dans «  margin ».",
      height:"Modifie la hauteur de l'attribut sélectionné",
      width:"Modifie la largeur de l'attribut sélectionné",
